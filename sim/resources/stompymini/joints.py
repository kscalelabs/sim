...
class Robot(Node):
    ...
    def default_standing(cls) -> Dict[str, float]:
        return {
            ...
            Robot.legs.right.hip_pitch: 2.9,
            Robot.legs.right.hip_roll: 1.,
            Robot.legs.right.hip_yaw: 3.2,
            Robot.legs.right.knee_pitch:  1.08,
            Robot.legs.right.ankle_pitch: -0.52,
        }
