...
class Actor(nn.Module):
    ...
    def forward(
        self,
        command_x: Tensor,  # x-coordinate of the target velocity
        command_y: Tensor,  # y-coordinate of the target velocity
        command_z: Tensor,  # target angular velocity
        ...
        Args:
            command_x: The x-coordinate of the target velocity, with shape (1).
            command_y: The y-coordinate of the target velocity, with shape (1).
            command_z: The target angular velocity, with shape (1).
        ...
        command_input = torch.cat(
            (
                sin_pos,
                cos_pos,
                command_x * self.lin_vel_scale,
                command_y * self.lin_vel_scale,
                command_z * self.ang_vel_scale,
            ),
            dim=0,
        )
