...
# Stompypro
echo "2. Stompypro:"
echo "Since gdown has a permissions issue, you need to download the files manually."
echo "   - Visit: https://drive.google.com/drive/folders/1-iIqy8j4gF6JeuMc_MjxkRe4vSZl8Ozp"
echo "   - Download all files and place them in 'sim/resources/stompypro/'"
