...
class GprHeadlessLatencyCfg(LeggedRobotCfg):
...
class GprHeadlessLatencyStandingCfg(GprHeadlessLatencyCfg):
...
class GprHeadlessLatencyCfgPPO(LeggedRobotCfgPPO):
    seed = 5
    ...
    class runner:
        ...
        experiment_name = "gpr_headless_latency"
        run_name = ""
        # load and resume
        resume = False
