...
class GprHeadlessLatencyPosCfg(LeggedRobotCfg):
...
class GprHeadlessLatencyPosStandingCfg(GprHeadlessLatencyPosCfg):
...
class GprHeadlessLatencyPosCfgPPO(LeggedRobotCfgPPO):
    seed = 5
    ...
    class runner:
        ...
        experiment_name = "gpr_headless_latency_pos"
        run_name = ""
        # load and resume
        resume = False
