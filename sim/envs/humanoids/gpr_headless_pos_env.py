...
class GprHeadlessPosEnv(LeggedRobot):
    """GprHeadlessPosEnv is a class that represents a custom environment for a legged robot.
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[(2 * num_joints + 5):(3 * num_joints + 5)] = 0.0
