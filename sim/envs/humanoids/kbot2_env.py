...
class KBot2Env(LeggedRobot):
    """KBot2Env is a class that represents a custom environment for a legged robot.
    ...
    def compute_ref_state(self):
        ...
        self.ref_dof_pos[:, self.legs_joints["right_ankle_pitch"]] += -sin_pos_r * scale_1 * -1
