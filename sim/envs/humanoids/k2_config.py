...
from sim.resources.k2.joints import Robot

NUM_JOINTS = len(Robot.all_joints())


class K2Cfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        foot_name = ["KB_D_501R_R_LEG_FOOT", "KB_D_501L_L_LEG_FOOT"]
        knee_name = ["KB_D_402L_L_Shin_Idle", "KB_D_401R_R_Shin_Drive"]
        imu_name = "imu_link"
...
class K2StandingCfg(K2Cfg):
    """Configuration class for the K2 humanoid robot."""
...
class K2CfgPPO(LeggedRobotCfgPPO):
    seed = 5
